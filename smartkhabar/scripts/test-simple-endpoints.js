...
const BASE_URL = 'https://smartkhabar-9v051z5je-prateeks-projects-018799ca.vercel.app';
...
async function testSimpleEndpoints() {
  console.log('🔍 Testing Simple News Endpoints');
  console.log('=================================');
  ...
  const tests = [
    ...
    { name: 'Breaking News (Original)', path: '/api/news/breaking?limit=3' },
    { name: 'Real-time News (Original)', path: '/api/news/realtime?limit=3' }
  ];
